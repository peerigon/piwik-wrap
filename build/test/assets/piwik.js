...
(function () {
  ...
  var c = new RegExp("[\0\xAD\u0600-\u0604\u070F\u17B4\u17B5\u200C-\u200F\u2028-\u202F\u2060-\u206F\uFEFF\uFFF0-\uFFFF]", "g"),
      e = "\\\\\\\"\0-\x1F\x7F-\x9F\xAD\u0600-\u0604\u070F\u17B4\u17B5\u200C-\u200F\u2028-\u202F\u2060-\u206F\uFEFF\uFFF0-\uFFFF]",
      i = new RegExp("[" + e, "g"),
      j,
      b,
      k = {
...
if ((typeof Piwik === "undefined" ? "undefined" : _typeof(Piwik)) !== "object") {
  Piwik = function () {
    ...
    var Q = {
      htmlCollectionToArray: function htmlCollectionToArray(Y) {
        var W = [],
            X;
      ...
      findMultiple: function findMultiple(Y) {
        if (!Y || !Y.length) {
          return [];
        }
      ...
      findNodesByTagName: function findNodesByTagName(X, W) {
      ...
      makeNodesUnique: function makeNodesUnique(W) {
        var ab = [].concat(W);
      ...
      getAttributeValueFromNode: function getAttributeValueFromNode(aa, Y) {
      ...
      hasNodeAttributeWithValue: function hasNodeAttributeWithValue(X, W) {
        var Y = this.getAttributeValueFromNode(X, W);
        return !!Y;
      },
      hasNodeAttribute: function hasNodeAttribute(Y, W) {
        if (Y && Y.hasAttribute) {
      ...
      hasNodeCssClass: function hasNodeCssClass(Y, W) {
        if (Y && W && Y.className) {
      ...
      findNodesHavingAttribute: function findNodesHavingAttribute(aa, Y, W) {
        if (!W) {
          W = [];
        }
      ...
      findFirstNodeHavingAttribute: function findFirstNodeHavingAttribute(Y, X) {
        if (!Y || !X) {
          return;
        }
      ...
      findFirstNodeHavingAttributeWithValue: function findFirstNodeHavingAttributeWithValue(Z, Y) {
        if (!Z || !Y) {
          return;
        }
      ...
      findNodesHavingCssClass: function findNodesHavingCssClass(aa, Z, W) {
        if (!W) {
          W = [];
        }
      ...
      findFirstNodeHavingClass: function findFirstNodeHavingClass(Y, X) {
        if (!Y || !X) {
          return;
        }
      ...
      isLinkElement: function isLinkElement(X) {
        if (!X) {
          return false;
        }
      ...
      setAnyAttribute: function setAnyAttribute(X, W, Y) {
        if (!X || !W) {
          return;
        }
    ...
    var m = {
      ...
      findContentNodesWithinNode: function findContentNodesWithinNode(Z) {
        if (!Z) {
          return [];
        }
      ...
      findParentContentNode: function findParentContentNode(X) {
        if (!X) {
          return;
        }
      ...
      findPieceNode: function findPieceNode(X) {
        var W;
      ...
      findTargetNodeNoDefault: function findTargetNodeNoDefault(W) {
        if (!W) {
          return;
        }
      ...
      findTargetNode: function findTargetNode(W) {
      ...
      findContentName: function findContentName(X) {
        if (!X) {
          return;
        }
      ...
      findContentPiece: function findContentPiece(X) {
        if (!X) {
          return;
        }
      ...
      findContentTarget: function findContentTarget(Y) {
        if (!Y) {
          return;
        }
      ...
      isSameDomain: function isSameDomain(W) {
        if (!W || !W.indexOf) {
          return false;
        }
      ...
      removeDomainIfIsInLink: function removeDomainIfIsInLink(Y) {
        var X = "^https?://[^/]+";
        var W = "^.*//[^/]+";
      ...
      findMediaUrlInNode: function findMediaUrlInNode(aa) {
        if (!aa) {
          return;
        }
      ...
      isOrWasNodeInViewport: function isOrWasNodeInViewport(ab) {
      ...
      isNodeVisible: function isNodeVisible(X) {
        var W = g(X);
        var Y = this.isOrWasNodeInViewport(X);
        return W && Y;
      },
      buildInteractionRequestParams: function buildInteractionRequestParams(W, X, Y, Z) {
        var aa = "";
      ...
      buildImpressionRequestParams: function buildImpressionRequestParams(W, X, Y) {
      ...
      buildContentBlock: function buildContentBlock(Y) {
        if (!Y) {
          return;
        }
      ...
      collectContent: function collectContent(Z) {
        if (!Z || !Z.length) {
          return [];
        }
      ...
      setLocation: function setLocation(W) {
        this.location = W;
      },
      ...
      toAbsoluteUrl: function toAbsoluteUrl(X) {
        if ((!X || String(X) !== X) && X !== "") {
          return X;
        }
      ...
      isUrlToCurrentDomain: function isUrlToCurrentDomain(X) {
      ...
      setHrefAttribute: function setHrefAttribute(X, W) {
        if (!X || !W) {
          return;
        }
      ...
      shouldIgnoreInteraction: function shouldIgnoreInteraction(Y) {
    ...
    function D(aI, bx) {
      var ad = N(u.domain, G.location.href, x()),
          ...
          bB = "GET",
          bD = bB,
          bi = "application/x-www-form-urlencoded; charset=UTF-8",
          aO = bi,
          aa = aI || "",
          ay = "",
          bz = "",
          ...
          bc,
          aW = u.title,
          aY = ["7z", "aac", "apk", "arc", "arj", "asf", "asx", "avi", "azw3", "bin", "csv", "deb", "dmg", "doc", "docx", "epub", "exe", "flv", "gif", "gz", "gzip", "hqx", "ibooks", "jar", "jpg", "jpeg", "js", "mobi", "mp2", "mp3", "mp4", "mpg", "mpeg", "mov", "movie", "msi", "msp", "odb", "odf", "odg", "ods", "odt", "ogg", "ogv", "pdf", "phps", "png", "ppt", "pptx", "qt", "qtm", "ra", "ram", "rar", "rpm", "sea", "sit", "tar", "tbz", "tbz2", "bz", "bz2", "tgz", "torrent", "txt", "wav", "wma", "wmv", "wpd", "xls", "xlsx", "xml", "z", "zip"],
          bA = [bX],
          ai = [],
          bo = [],
          aG = [],
          ...
          ak,
          an,
          a2 = ["pk_campaign", "piwik_campaign", "utm_campaign", "utm_source", "utm_medium"],
      ...
      function bk(cr, cs) {
        var cp = new Date(),
            cq = aX("action_name=" + l(V(cr || aW)), cs, "log");
        a3(cq, by);
      }
      ...
      function b0(ct, cp, cu, cq) {
        ...
        var cs = aK(bo, "download"),
            cr = aK(aG, "link"),
            cv = new RegExp("\\.(" + aY.join("|") + ")([?&#]|$)", "i");
      ...
      return {
        ...
        setTrackerUrl: function setTrackerUrl(cp) {
          aa = cp;
        },
        ...
        setSiteId: function setSiteId(cp) {
          cl(cp);
        },
        setUserId: function setUserId(cp) {
          if (!w(cp) || !cp.length) {
            return;
          }
        ...
        setCustomData: function setCustomData(cp, cq) {
          if (J(cp)) {
            an = cp;
          } else {
            if (!an) {
        ...
        setCustomRequestProcessing: function setCustomRequestProcessing(cp) {
          au = cp;
        },
        appendToTrackingUrl: function appendToTrackingUrl(cp) {
          bz = cp;
        },
        getRequest: function getRequest(cp) {
          return aX(cp);
        },
        addPlugin: function addPlugin(cp, cq) {
          a[cp] = cq;
        },
        setCustomVariable: function setCustomVariable(cq, cp, ct, cr) {
          var cs;
        ...
        getCustomVariable: function getCustomVariable(cq, cr) {
          var cp;
        ...
        deleteCustomVariable: function deleteCustomVariable(cp, cq) {
        ...
        setLinkTrackingTimer: function setLinkTrackingTimer(cp) {
          by = cp;
        },
        setDownloadExtensions: function setDownloadExtensions(cp) {
          if (n(cp)) {
            cp = cp.split("|");
          }
        ...
        addDownloadExtensions: function addDownloadExtensions(cq) {
          var cp;
        ...
        removeDownloadExtensions: function removeDownloadExtensions(cr) {
          var cq,
              cp = [];
        ...
        setDomains: function setDomains(cp) {
          bA = n(cp) ? [cp] : cp;
          bA.push(bX);
        },
        setIgnoreClasses: function setIgnoreClasses(cp) {
          ai = n(cp) ? [cp] : cp;
        },
        setRequestMethod: function setRequestMethod(cp) {
          bD = cp || bB;
        },
        setRequestContentType: function setRequestContentType(cp) {
          aO = cp || bi;
        },
        setReferrerUrl: function setReferrerUrl(cp) {
          bF = cp;
        },
        setCustomUrl: function setCustomUrl(cp) {
          bc = bW(ci, cp);
        },
        setDocumentTitle: function setDocumentTitle(cp) {
          aW = cp;
        },
        setAPIUrl: function setAPIUrl(cp) {
          ay = cp;
        },
        setDownloadClasses: function setDownloadClasses(cp) {
          bo = n(cp) ? [cp] : cp;
        },
        setLinkClasses: function setLinkClasses(cp) {
          aG = n(cp) ? [cp] : cp;
        },
        setCampaignNameKey: function setCampaignNameKey(cp) {
          a2 = n(cp) ? [cp] : cp;
        },
        setCampaignKeywordKey: function setCampaignKeywordKey(cp) {
          aT = n(cp) ? [cp] : cp;
        },
        discardHashTag: function discardHashTag(cp) {
          ak = cp;
        },
        setCookieNamePrefix: function setCookieNamePrefix(cp) {
          cg = cp;
          ag = ar();
        },
        setCookieDomain: function setCookieDomain(cp) {
          var cq = y(cp);
        ...
        setCookiePath: function setCookiePath(cp) {
          ch = cp;
          bu();
        },
        setVisitorCookieTimeout: function setVisitorCookieTimeout(cp) {
          ax = cp * 1000;
        },
        setSessionCookieTimeout: function setSessionCookieTimeout(cp) {
          aD = cp * 1000;
        },
        setReferralCookieTimeout: function setReferralCookieTimeout(cp) {
          bg = cp * 1000;
        },
        setConversionAttributionFirstReferrer: function setConversionAttributionFirstReferrer(cp) {
          a9 = cp;
        },
        ...
        setDoNotTrack: function setDoNotTrack(cq) {
        ...
        addListener: function addListener(cq, cp) {
          bK(cq, cp);
        },
        enableLinkTracking: function enableLinkTracking(cp) {
          b6 = true;
        ...
        setGenerationTimeMs: function setGenerationTimeMs(cp) {
          aL = parseInt(cp, 10);
        },
        enableHeartBeatTimer: function enableHeartBeatTimer(cp) {
          cp = Math.max(cp, 1);
          b2 = (cp || 15) * 1000;
        ...
        redirectFile: function redirectFile(cp) {
          if (G.location.protocol === "file:") {
            G.location = cp;
          }
        },
        setCountPreRendered: function setCountPreRendered(cp) {
          a4 = cp;
        },
        trackGoal: function trackGoal(cp, cr, cq) {
          aQ(function () {
            bw(cp, cr, cq);
          });
        },
        trackLink: function trackLink(cq, cp, cs, cr) {
          aQ(function () {
            bZ(cq, cp, cs, cr);
          });
        },
        trackPageView: function trackPageView(cp, cq) {
          ah = [];
        ...
        trackVisibleContentImpressions: function trackVisibleContentImpressions(cp, cq) {
          if (A(b4)) {
            return;
          }
        ...
        trackContentImpression: function trackContentImpression(cr, cp, cq) {
          if (A(b4)) {
            return;
          }
        ...
        trackContentImpressionsWithinNode: function trackContentImpressionsWithinNode(cp) {
          if (A(b4) || !cp) {
            return;
          }
        ...
        trackContentInteraction: function trackContentInteraction(cr, cs, cp, cq) {
          if (A(b4)) {
            return;
          }
        ...
        trackContentInteractionNode: function trackContentInteractionNode(cq, cp) {
          if (A(b4) || !cq) {
            return;
          }
        ...
        trackEvent: function trackEvent(cq, cs, cp, cr) {
          aQ(function () {
            al(cq, cs, cp, cr);
          });
        },
        trackSiteSearch: function trackSiteSearch(cp, cr, cq) {
          aQ(function () {
            aR(cp, cr, cq);
          });
        },
        setEcommerceView: function setEcommerceView(cs, cp, cr, cq) {
          if (!w(cr) || !cr.length) {
            cr = "";
          } else {
        ...
        addEcommerceItem: function addEcommerceItem(ct, cp, cr, cq, cs) {
          if (ct.length) {
            bQ[ct] = [ct, cp, cr, cq, cs];
          }
        },
        trackEcommerceOrder: function trackEcommerceOrder(cp, ct, cs, cr, cq, cu) {
          bU(cp, ct, cs, cr, cq, cu);
        },
        trackEcommerceCartUpdate: function trackEcommerceCartUpdate(cp) {
          cf(cp);
        }
      };
    }
    ...
    _paq = new v();
    d = {
      addPlugin: function addPlugin(W, X) {
        a[W] = X;
      },
      getTracker: function getTracker(W, X) {
        if (!w(X)) {
...
if (typeof piwik_log !== "function") {
  piwik_log = function piwik_log(b, f, d, g) {
    function a(h) {
      try {
    ...
    if (a("install_tracker")) {
      piwik_track = function piwik_track(i, k, j, h) {
        e.setSiteId(k);
        e.setTrackerUrl(j);
        e.trackLink(i, h);
      };
